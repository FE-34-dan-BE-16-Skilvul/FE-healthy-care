...
const Cart = () => {
    ...
    const cartTotal = cartItems.map(item => item.kalori * item.quantity).reduce((prevValue, currValue) => prevValue + currValue, 0);
                    ...
                    <div id="cart">
                        <div className="cart_content">
                            <div className="cart_head">
                                <h2>Keranjang <small>({cartQuantity})</small></h2>
                                <div
                                    title="Close"
                                    className="close_btn"
                                            ...
                                            return (
                                                <div className="cart_items" key={id}>
                                                    ...
                                                    <div className="cart_items_info">
                                                        ...
                                                        <h6 className="kalori"> {kalori.toLocaleString()} kal / 100 gram</h6>
                                                        <h4 className="nilai_kalori"> {itemTotal.toLocaleString()} kalori</h4>
                                                    </div>
